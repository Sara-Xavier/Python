Litro_alcool,Litro_gasolina,Rendimento_alcool,Rendimento_gasolina = map(float,input().split())
comparacao = (Litro_gasolina*Rendimento_alcool)/Rendimento_gasolina
 
if comparacao <= Litro_alcool:
    print('G')
